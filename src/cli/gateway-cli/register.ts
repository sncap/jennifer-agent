      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["jennifer gateway run", "Run the gateway in the foreground."],
            ["jennifer gateway status", "Show service status and probe reachability."],
            ["jennifer gateway discover", "Find local and wide-area gateway beacons."],
            ["jennifer gateway call health", "Call a gateway RPC method directly."],
