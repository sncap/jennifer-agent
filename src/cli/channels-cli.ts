    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["jennifer channels list", "List configured channels and auth profiles."],
          ["jennifer channels status --probe", "Run channel status checks and probes."],
          [
            "jennifer channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["jennifer channels login --channel whatsapp", "Link a WhatsApp Web account."],
